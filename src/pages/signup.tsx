                    ...
                    <div className="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                        ...
                        <form method="Post" action="" className="mt-10" id="formSignup" >
                            <div className="mb-4">
                                ...
                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="User name" id="username" />
                            </div>
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-normal mb-2" htmlFor="username">
                                    Email
