...
const HeaderAdmin = (props: Props) => {
  return (
    <div>
        <header className="pb-5 bg-white shadow-md dark:bg-gray-800">
            <div className="container flex items-center justify-between h-20 px-6 mx-auto text-purple-600 dark:text-purple-300">
                <div className="flex justify-center flex-1 lg:mr-32">
                    <div className="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                        <form className="w-[700px] mt-5 pl-10 flex ">
                            <input type="text" className="h-10 w-10/12 pl-3 border border-black rounded-sm" placeholder="Nhập tên điện thoại, máy tính, phụ kiện... cần tìm" />
                            <div>
                                <button className="bg-[#2b2d42] text-[#ffffff] hover:text-[#d8d8d8] px-[20px] py-[8px] rounded-r-lg">Tìm kiếm</button>
                            </div>
                        </form>
                    </div>
                </div>
